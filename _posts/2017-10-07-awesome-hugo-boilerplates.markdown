...
<br>No awesome list would be complete if I didn't selfishly promote some of of my own stuff amirite!? I built after Dark specifically to create my [Hack Cabin](https://hackcabin.com) website. It uses a design concept I call _Deceptive Simplicity_ and introduces cutting edge Web tech without going overboard on tooling. Check out [After Dark](https://after-dark.habd.as/) for a wild trip back in time, when Geocities and Angelfire reined supreme.

[![After Dark logo](https://cdn.jsdelivr.net/npm/after-dark@latest/images/docs/minimal-mac.png)](https://after-dark.habd.as/)
